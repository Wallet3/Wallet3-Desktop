...
export default (args: { app: Application }) => {
  ...
  return <div className="page locking">{app.touchIDSupported ? <TouchIDView {...args} /> : <PasscodeView {...args} />}</div>;
};
    ...
    <div className="touchid-view" tabIndex={0} onKeyDown={onKeyDown}>
      ...
      <div>
        ...
        >
          <g>
            <path
              d="M206.206,281.068c-0.623-4.676-4.958-7.97-9.6-7.305c-4.668,0.623-7.936,4.924-7.305,9.6
            ...
            />
            <path
              d="M82.55,291.035c-0.085-0.401-0.196-0.785-0.333-1.169c-1.724-8.858-2.773-17.86-3.149-26.786
            ...
            />
            <path
              d="M130.516,358.995c-4.395-1.707-9.344,0.469-11.051,4.864c-9.148,23.561-24.311,44.467-43.836,60.459
            ...
            />
            <path
              d="M51.198,117.134c1.519,1.109,3.277,1.647,5.026,1.647c2.628,0,5.222-1.212,6.895-3.507
            ...
            />
            <path
              d="M22.04,303.263c-0.043-0.205-0.179-0.358-0.239-0.563c-10.624-53.316-3.191-107.008,21.538-155.315
            ...
            />
            <path
              d="M217.59,65.857c-79.061,15.94-139.076,77.577-152.892,157.022c-0.802,4.642,2.304,9.062,6.946,9.873
            ...
            />
            <path
              d="M325.05,242.139c-3.721-18.458-14.404-34.364-30.089-44.783c-15.684-10.428-34.492-14.097-52.941-10.394
            ...
            />
            <path
              d="M264.369,254.384c-0.93-4.617-5.427-7.586-10.052-6.682c-4.617,0.93-7.612,5.436-6.682,10.052
            ...
            />
            <path
              d="M506.853,205.488c-0.051-0.256-0.222-0.452-0.299-0.708c-13.141-64.265-49.911-120.397-103.62-158.089
            ...
            />
            <path
              d="M385.611,229.936c-6.98-34.645-27.034-64.486-56.465-84.036c-29.431-19.558-64.708-26.462-99.345-19.49
            ...
            />
            <path
              d="M445.609,273.857c-4.702,0.299-8.277,4.352-7.979,9.054c3.081,48.922-1.758,97.766-14.387,145.169
            ...
            />
            <path
              d="M373.818,406.568c-4.582-1.237-9.233,1.476-10.445,6.033c-6.502,24.26-15.369,48.008-26.377,70.588
            ...
            />
            <path
              d="M322.191,341.211c-4.651-0.529-8.917,2.825-9.446,7.509c-6.093,53.359-25.429,105.139-55.936,149.726
